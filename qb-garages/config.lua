...
JobVehicles = {
	['police'] = { -- job
        ...
        vehicles = {
            [0] = { -- Just Copy and Paste to Add more grades
                ["legacycvpi"] = "Crown Victoria",
                ["legacycap"] = "Caprice",
                ["legacyfpis"] = "Taurus",
            }
...
Garages = {
    ...
    ['pdgarage'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
                vector2(450.17471313477, -1000.1641235352),
                vector2(450.53161621094, -973.06701660156),
                vector2(423.14028930664, -972.94024658203),
                vector2(423.1572265625, -1000.2595214844),
            },
    ...
    ['emsgarage'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
                vector2(-1839.3913574219, -325.67071533203),
                vector2(-1849.6433105469, -322.04263305664),
                vector2(-1848.9096679688, -319.77923583984),
                vector2(-1851.4501953125, -318.79959106445),
                vector2(-1849.2667236328, -314.52059936523),
                vector2(-1836.9946289063, -318.41940307617),
            },
            ['minZ'] = 47.0,  -- min height of the parking zone
        ...
        drawText = 'Parking',
        ["ParkingSpots"] = {
            vector4(-1844.64, -317.17, 49.14, 53.9),
        },
        debug = false
    },
    ['kinggarage'] = {
        ['Zone'] = {
            ['Shape'] = { --polygon that surrounds the parking area
                vector2(941.271484375, -2114.2927246094),
                vector2(942.47442626953, -2103.9111328125),
                vector2(959.1435546875, -2102.9389648438),
                vector2(958.25738525391, -2116.9692382813),
            },
            ['minZ'] = 29.0,  -- min height of the parking zone
            ['maxZ'] = 32.0,  -- max height of the parking zone
        },
        label = 'Garaje de King Performance',
        type = 'job',
        job = "mechanic",
        useVehicleSpawner = true,
        vehicleCategories = {'car', 'emergency'},
        drawText = 'Parking King Performance',
        ["ParkingSpots"] = {
            vector4(949.9, -2111.42, 30.55, 80.02),
            vector4(950.65, -2106.03, 30.6, 89.87),
